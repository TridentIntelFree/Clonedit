...
/* ================================================================
   ...
   ================================================================ */
const BUILD = 'JBH-88 · R161 · 2026-08-19 · what survives being saved';
...
function pcmRestore(i16,pk){
  const k=((pk>0&&isFinite(pk))?pk:1)/32767, f=new Float32Array(i16.length);
  for(let i=0;i<i16.length;i++) f[i]=i16[i]*k;
  return f;
}
function f32ToB64(f32,pk){
  const i16=pcmQuant(f32,(pk>0&&isFinite(pk))?pk:1);
