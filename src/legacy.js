...
/* ================================================================
   ...
   ================================================================ */
const BUILD = 'JBH-88 · R136 · 2026-07-29 · one dash is not evidence about the transport';
...
function buildLoudTap(){
  ...
  try{
    ...
    kGraph=LIVE; kErr='';
  }catch(e){ kAn=null; kGraph=null; kErr=(e&&e.message)||String(e); }
}
function outDraw(){
  const cv=$('spectrum');
