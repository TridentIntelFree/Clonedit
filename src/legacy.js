...
/* ================================================================
   ...
   ================================================================ */
const BUILD = 'JBH-88 · R169 · 2026-08-19 · the output category becomes a choice';
...
function applyAudioRoute(){
  ...
  try{ if(navigator.audioSession) navigator.audioSession.type = open ? 'play-and-record' : sessPref; }catch(e){}
  drawRoutePip();
  return open;
}
